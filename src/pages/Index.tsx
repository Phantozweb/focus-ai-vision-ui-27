      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">AI-Powered Learning Tools</h2>
        ...
        <section className="container mx-auto px-4 py-12 bg-darkBg-lighter rounded-2xl my-8">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">What Students Are Saying</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-xl bg-darkBg border border-slate-800">
              <div className="flex items-center mb-4">
                <div className="bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold">T</div>
                <h3 className="ml-3 text-lg font-medium text-white">Thirumalai</h3>
              </div>
              <p className="text-slate-400">"Focus.AI has been incredibly helpful in breaking down complex optometry topics that I was struggling to understand."</p>
            </div>
            
            <div className="p-6 rounded-xl bg-darkBg border border-slate-800">
              <div className="flex items-center mb-4">
                <div className="bg-green-600 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold">S</div>
                <h3 className="ml-3 text-lg font-medium text-white">Shobana</h3>
              </div>
              <p className="text-slate-400">"I've finally been able to make proper notes and study effectively. The AI assistant answers all my questions instantly."</p>
            </div>
            
            <div className="p-6 rounded-xl bg-darkBg border border-slate-800">
              <div className="flex items-center mb-4">
                <div className="bg-purple-600 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold">D</div>
                <h3 className="ml-3 text-lg font-medium text-white">CS Dharsini</h3>
              </div>
              <p className="text-slate-400">"The notes generated by Focus.AI are much easier to understand than my textbooks. Highly recommended!"</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col justify-center">
              ...
              <div className="text-slate-400">
                <p>For any questions, contact us at: <code className="bg-slate-800 rounded px-2 py-1">iamsirenjeev@gmail.com</code></p>
              </div>
            </div>
