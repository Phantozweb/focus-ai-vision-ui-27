    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 overflow-hidden">
      <div className="bg-white rounded-lg max-w-4xl w-full h-[90vh] flex flex-col shadow-xl">
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-white print-container" id="pdf-export-content" ref={contentRef}>
          ...
          <div className="premium-pdf-header mb-4 bg-gradient-to-r from-blue-50 to-white p-3 rounded-lg border border-blue-100">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-xl font-bold text-blue-700">{customTitle}</h1>
          ...
          {/* Simplified footer */}
          <div className="mt-4 pt-2 border-t border-gray-200 text-center pdf-footer flex flex-col items-center">
